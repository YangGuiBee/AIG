...
| 자격증명 | 취득기관 | 설명 |
|---|---|---|
| **AICE (AI Intelligence Certificate)** | AICE 운영기관 (KT·한국AI협회)]<br>https://aice.study) | 국가 공인 민간형 AI 역량 인증 체계로, 인공지능의 개념 이해부터 데이터 분석, 머신러닝 활용, AI 서비스 적용 능력까지를 단계별(Level 1~4)로 평가한다. 산업 현장에서 요구되는 **AI 실무 역량 검증**을 목적으로 설계되었으며, 기업 실무자·학생·구직자의 AI 활용 능력을 객관적으로 인증하는 데 활용 |
| **빅데이터분석기사** | 한국산업인력공단(Q-net)<br>https://www.q-net.or.kr| 데이터를 기반으로 한 의사결정 및 문제 해결 능력을 검증하는 국가기술자격으로, 데이터 수집·전처리, 통계 분석, 데이터 모델링, 시각화 및 결과 해석 전반을 평가한다. **공공·기업 부문의 데이터 분석 전문 인력 양성**을 목표로 하며, AI·머신러닝 연구 및 데이터 기반 정책·서비스 설계의 기초 자격으로 활용 |
| **정보처리기사** | 한국산업인력공단(Q-net)<br>https://www.q-net.or.kr | 소프트웨어 개발과 정보시스템 구축·운영에 필요한 기본 역량을 검증하는 국가기술자격으로, 알고리즘, 자료구조, 데이터베이스, 운영체제, 네트워크, 시스템 분석·설계 등을 포괄적으로 다룬다. AI·데이터 분야에서도 **시스템 이해 및 소프트웨어 기반 역량의 기초 자격**으로 폭넓게 활용 |
