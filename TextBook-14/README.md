...
| 자격증명 | 취득기관 | 설명 |
|---|---|---|
| **한국AI교육진흥원 AI 자격증(4종)** | 한국AI교육진흥원<br>[한국AI교육진흥원 공식 홈페이지](https://www.kaiie.or.kr/) | 인공지능에 대한 기초 소양부터 실무 활용, 윤리 및 교육 역량까지를 단계적으로 평가하기 위해 구성된 민간자격 체계로, **AI지도사, AI인공지능전문가, AI활용능력, AI윤리전문가** 등 4종 자격으로 이루어져 있다. 일반인·교육자·실무자를 대상으로 AI 이해 확산과 활용 역량 강화를 목표로 하며, AI 윤리와 책임 있는 활용에 대한 교육 내용을 포함하고 있다. |
| **AI‑POT (AI Prompt Optimization Tester)** | 한국인공지능협회(KAIA, Korea Artificial Intelligence Association)<br>[한국인공지능협회 공식 홈페이지](https://www.koraia.org) | 생성형 AI 환경에서 요구되는 **프롬프트 설계·최적화 역량**을 평가하는 실무 중심 민간자격이다. 대규모 언어모델(LLM)의 특성을 이해하고 목적에 맞는 프롬프트를 작성·개선·검증하는 능력을 중점적으로 평가하며, AI 도구를 실제 업무에 효과적으로 활용할 수 있는 역량을 강조한다. |
| **생성형 AI 자격증** | 한국GPT협회<br>[한국GPT협회 공식 홈페이지](https://koreagpt.org/) | ChatGPT 등 생성형 AI 기술의 기본 원리와 활용 방법을 이해하고 이를 교육, 업무, 콘텐츠 제작 등 다양한 분야에 적용할 수 있는 능력을 평가하는 민간자격이다. 생성형 AI의 활용 사례와 함께 한계 및 윤리적 쟁점도 다루며, **생성형 AI 리터러시와 실무 활용 역량 향상**을 주요 목적으로 한다. |
| **AI 인공지능지도사 (ISO/IEC 42001 기반)** | 한국인공지능진흥협회(KAIPA, Korea Artificial Intelligence Promotion Association)<br>[한국인공지능진흥협회 공식 홈페이지](https://www.kaipa.or.kr) | 조직 차원의 AI 활용을 지도·관리할 수 있는 인력을 양성하기 위한 자격으로, **ISO/IEC 42001(인공지능 경영관리시스템)** 개념을 기반으로 AI 거버넌스, 위험관리, 책임성, 윤리 원칙 등을 중심적으로 다룬다. 기술 활용보다는 **AI 관리체계 수립·운영과 정책적 관점**에 초점을 둔 자격이다. |
