...
▣ 개요 : ISO/IEC 25010:2011은 소프트웨어 및 시스템의 품질을 체계적으로 정의한 국제표준으로, 기능적 품질과 사용 품질을 구조화된 품질 특성 모델로 제시한다. 본 표준은 전통적인 정보시스템·소프트웨어 품질 평가의 기준을 제공하며, 이후 제정된 **AI 시스템 품질 표준(ISO/IEC 25059)**의 개념적·구조적 기반 역할을 수행한다. 즉, AI 품질 논의의 출발점이 되는 기존 품질 모델의 기준 표준이다.

▣ 표준의 특성 : 비인증 표준
품질 모델 정의를 위한 기초(Foundational) 표준
SQuaRE(Software Product Quality Requirements and Evaluation) 시리즈의 핵심 표준
AI를 직접 대상으로 하지는 않으나, AI 시스템 품질 특성 정의의 기준 프레임을 제공

▣ 구성 요약 :
이중 품질 모델 구조 : 제품 품질(Product quality)과 사용 품질(Quality in use)을 분리하여 정의함으로써, 시스템 자체의 특성과 사용자 관점의 효과를 구분
제품 품질 특성 체계화 : 기능적 적합성, 성능 효율성, 호환성, 사용성, 신뢰성, 보안성, 유지보수성, 이식성의 8대 품질 특성을 제시
사용 품질 중심 접근 : 실제 사용 환경에서의 효과성, 효율성, 만족도, 위험 회피, 맥락 적합성을 품질 요소로 포함
AI 품질 모델의 기초 제공 : 이후 AI 시스템의 특성(학습, 적응, 불확실성)을 반영한 품질 확장 논의의 기준점 역할 수행

▣ 관련되는 다른 국제 표준 :
ISO/IEC 25000 시리즈(SQuaRE) : 소프트웨어 및 시스템 품질 요구사항과 평가 프레임워크
ISO/IEC 25059:2023 : AI 시스템 품질 모델 (25010 품질 특성의 AI 확장)
ISO/IEC 22989:2022 : 인공지능 개념 및 용어 (AI 품질 논의의 개념적 정합성 제공)
ISO/IEC 42001:2023 : 인공지능 경영시스템 (조직 차원의 품질·책임 관리와 연계)

▣ 전문 출처 : https://www.iso.org/standard/35733.html

▣ 목차 :


적용 범위
시스템 및 소프트웨어 제품의 품질 모델 정의를 위한 표준의 적용 범위를 규정


인용 표준
본 표준을 이해·적용하기 위해 함께 참조해야 하는 관련 표준 제시


용어 및 정의
품질 모델, 품질 특성, 품질 측정과 관련된 핵심 용어를 명확히 정의


품질 모델 개요
SQuaRE 시리즈 내에서 본 표준의 위치와 전체 품질 모델 구조를 설명


제품 품질 모델
시스템·소프트웨어 자체가 갖추어야 할 품질 특성을 구조적으로 제시
...
사용 품질 모델
실제 사용 맥락에서 시스템이 제공하는 품질을 사용자 관점에서 정의
6.1 효과성 : 사용 목적 달성 정도
6.2 효율성 : 투입 대비 성과
6.3 만족도 : 사용자 인식 및 신뢰
...
▣ 개요 :
ISO/IEC 25059:2023은 인공지능(AI) 시스템의 품질을 체계적으로 정의하기 위한 국제표준으로, 기존 소프트웨어 품질 모델(ISO/IEC 25010)을 기반으로 하여 학습, 적응, 데이터 의존성, 불확실성 등 AI 시스템 고유의 특성을 반영한 품질 모델을 제시한다. 본 표준은 AI 시스템을 단순한 소프트웨어가 아닌 데이터·모델·알고리즘·운영 환경이 결합된 복합 시스템으로 규정하고, 이에 대한 품질 특성과 평가 관점을 구조화한다.

▣ 표준의 특성 :
비인증 표준
AI 시스템 품질 정의를 위한 확장 품질 모델 표준
SQuaRE(소프트웨어 품질 요구사항 및 평가) 시리즈의 AI 특화 표준
ISO/IEC 25010 품질 모델을 AI 맥락에 맞게 재해석·확장한 기준 표준

▣ 구성 요약 :


AI 시스템 중심의 품질 모델 제시
AI 시스템을 모델·데이터·학습 과정·운영 환경을 포함한 전체 시스템 단위로 정의


기존 품질 특성의 AI 확장
기능성, 신뢰성, 보안성 등 전통적 품질 특성을 AI 특성에 맞게 재정의


데이터·학습·적응 요소 반영
데이터 품질, 학습 성능의 안정성, 환경 변화에 대한 적응성을 품질 요소로 포함


신뢰 가능한 AI 관점 반영
공정성, 투명성, 설명가능성, 안전성 등 AI 거버넌스 논의와 연계 가능한 품질 관점 제시



▣ 관련되는 다른 국제 표준 :
ISO/IEC 25010:2011 : 기존 시스템 및 소프트웨어 품질 모델 (본 표준의 기반)
ISO/IEC 25000 시리즈(SQuaRE) : 품질 요구사항 정의 및 평가를 위한 프레임워크
ISO/IEC 22989:2022 : 인공지능 개념 및 용어 (AI 품질 개념 정합성 확보)
ISO/IEC 23894:2023 : 인공지능 위험관리 (품질 저하를 위험 요인으로 해석 가능)
ISO/IEC 42001:2023 : 인공지능 경영시스템 (조직 차원의 AI 품질 관리와 연계)

▣ 전문 출처 : https://www.iso.org/standard/80572.html

▣ 목차 :

적용 범위 : AI 시스템 품질 모델의 적용 대상과 활용 범위를 규정
인용 표준 : 본 표준을 적용할 때 함께 사용되는 관련 국제표준 제시
용어 및 정의 : AI 시스템 품질 평가에 필요한 핵심 개념과 용어를 정의
AI 시스템 품질 모델 개요 : AI 품질 모델의 목적과 구조, 기존 품질 모델(25010)과의 관계 설명
AI 시스템 품질 특성 : AI 시스템이 갖추어야 할 주요 품질 특성을 체계적으로 제시
...
사용 맥락에서의 AI 품질 : 실제 사용 환경에서 AI 시스템 품질이 어떻게 인식·영향을 미치는지 설명
AI 시스템 품질 평가 활용 : 본 품질 모델을 요구사항 정의, 평가, 거버넌스 체계에 적용하는 방법 제시

## [3-6] ISO/IEC 25704:AWI AI 개발·운영 프로세스 능력 평가 모델(Artificial intelligence — Process assessment)

▣ 개요 :
ISO/IEC 25704는 인공지능(AI) 시스템의 개발 및 운영 프로세스의 성숙도와 능력을 평가하기 위한 국제표준으로 개발 중인 문서(AWI)이다. 본 표준은 AI 시스템의 품질과 신뢰성이 단순히 기술 성능이 아니라 조직의 프로세스 역량에 의해 좌우된다는 전제하에, AI 기획·개발·검증·배포·운영 전 과정에 대한 체계적인 프로세스 평가 모델을 제시하는 것을 목표로 한다. 향후 AI 거버넌스, 책임성, 지속적 개선을 위한 프로세스 기반 관리 표준으로 활용될 수 있는 성격을 가진다.

▣ 표준의 특성 :
개발 중 표준(AWI, Approved Work Item)
AI 시스템 개발·운영 프로세스 능력 평가 모델(Process assessment model)
ISO/IEC 33000 계열(프로세스 평가) 접근을 AI 분야에 적용한 확장 표준
AI 경영시스템(ISO/IEC 42001)과 조직 실행 수준에서 직접 연계되는 표준

▣ 구성 요약 :


프로세스 중심 AI 관리 접근
AI의 성능·윤리·안전 문제를 기술 자체가 아닌 개발·운영 프로세스의 결과로 해석


AI 생명주기 전반의 프로세스 정의
기획, 데이터 준비, 모델 개발, 검증, 배포, 운영, 모니터링, 개선 단계별 프로세스를 체계화


능력 수준 평가 개념 도입
조직의 AI 관련 프로세스를 단계별 성숙도 수준으로 평가할 수 있는 기준 제공


거버넌스 및 책임성 강화
인간 감독, 의사결정 책임, 문서화, 변경관리 등 AI 거버넌스 요소를 프로세스 요구사항으로 포함



▣ 관련되는 다른 국제 표준 :
ISO/IEC 33000 시리즈 : 프로세스 평가 및 성숙도 모델에 대한 일반 프레임워크
ISO/IEC 42001:2023 : 인공지능 경영시스템 (조직 차원의 AI 관리 요구사항)
ISO/IEC 23894:2023 : 인공지능 위험관리 (위험 식별·평가·완화 프로세스와 연계)
ISO/IEC 25059:2023 : AI 시스템 품질 모델 (프로세스 결과로서의 품질 개념과 연결)

▣ 전문 출처 : 정식 국제표준 미발행 (AWI 단계)

▣ 목차 (각 항목별 간단 개요 포함) :
적용 범위
AI 시스템 개발·운영 프로세스 능력 평가에 대한 표준의 적용 범위를 정의


인용 표준
본 표준과 함께 참조되는 프로세스 평가 및 AI 관련 국제표준 제시


용어 및 정의
AI 프로세스, 능력 수준, 평가 기준과 관련된 핵심 개념 정의


AI 프로세스 평가 개요
AI 분야에서 프로세스 평가가 필요한 이유와 기본 접근 방식 설명


AI 시스템 생명주기 프로세스
AI 시스템 전 생명주기에 걸친 주요 프로세스를 구조적으로 정의
...
프로세스 능력 수준 평가
각 프로세스가 어느 수준의 성숙도를 갖는지 평가하기 위한 기준 제시


평가 수행 및 결과 활용
프로세스 평가 결과를 조직 개선, 거버넌스, 의사결정에 활용하는 방법 설명
